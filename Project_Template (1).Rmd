...
library(tidyverse)
pfos<- read_csv("PFOSWholeStateWRegions.csv")
#this is the PFOS data for the state of virginia

systems<- read.csv("Active Systems.csv")
head(systems)
#these are all of the active water systems across the state
```
